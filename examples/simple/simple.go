...
func main() {
	...
	ping.Receive("ok", func(response interface{}) {
	...
	ping.Receive("error", func(response interface{}) {
		log.Fatal(response)
	})
	ping.Receive("timeout", func(response interface{}) {
		log.Fatal(response)
	})
	...
	channel.On("shout", func(payload interface{}) {
	...
	shout.Receive("timeout", func(response interface{}) {
